...
public partial class GameContext {
    ...
    public GameEntity SetTimerManager(long newLastTime, long newAccumulator, long newSceneTimerId) {
        if (hasTimerManager) {
        ...
        entity.AddTimerManager(newLastTime, newAccumulator, newSceneTimerId);
        return entity;
    }

    public void ReplaceTimerManager(long newLastTime, long newAccumulator, long newSceneTimerId) {
        var entity = timerManagerEntity;
        if (entity == null) {
            entity = SetTimerManager(newLastTime, newAccumulator, newSceneTimerId);
        } else {
            entity.ReplaceTimerManager(newLastTime, newAccumulator, newSceneTimerId);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddTimerManager(long newLastTime, long newAccumulator, long newSceneTimerId) {
