...
public partial class InputContext {
    ...
    public InputEntity SetInput(UnityEngine.Vector2 newAxis, UnityEngine.Vector3 newRotate) {
        if (hasInput) {
        ...
        entity.AddInput(newAxis, newRotate);
        return entity;
    }

    public void ReplaceInput(UnityEngine.Vector2 newAxis, UnityEngine.Vector3 newRotate) {
        var entity = inputEntity;
        if (entity == null) {
            entity = SetInput(newAxis, newRotate);
        } else {
            entity.ReplaceInput(newAxis, newRotate);
        }
    }
...
public partial class InputEntity {
    ...
    public void AddInput(UnityEngine.Vector2 newAxis, UnityEngine.Vector3 newRotate) {
