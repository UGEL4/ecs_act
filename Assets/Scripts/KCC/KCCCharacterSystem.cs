...
namespace ACTGame
{
    namespace KCC
    {
        ...
        /// </summary>
        public class KCCCharacterSystem : Singleton<KCCCharacterSystem>
        {
            ...
            /// <summary>
            /// Creates a KCCCharacterSystem instance if there isn't already one
            /// </summary>
            ...
            /// <summary>
            /// Gets the KCCCharacterSystem instance if any
            /// </summary>
            /// <returns></returns>
            public static KCCCharacterSystem GetInstance()
            {
                return Instance;
            }
